...
def attack(char_name: int, char_class: int):
    """Функция совершает атаку."""
    ...
    return f'{char_name}, Вы не выбрали класс. Вернитесь на главное меню.'


def defence(char_name: int, char_class: int):
...
def special(char_name: int, char_class: int):
    """Функция спец.умения."""
    if char_class == 'warrior':
...
def start_training(char_name: int, char_class: int):
...
def choice_char_class():
    """Функция позволяет выбрать класс."""
    approve_choice = None
    char_class = None
